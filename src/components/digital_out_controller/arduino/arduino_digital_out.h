...
/* Include Guard */
#ifndef THE_HAL_ARDUINO_DIGITAL_OUT_H_
#define THE_HAL_ARDUINO_DIGITAL_OUT_H_
...
class DigitalOut
{
    public:
        ...
        bool setup(const uint8_t initial_value=LOW);
        bool set_low(void);
        bool set_high(void);
...
#endif /* THE_HAL_ARDUINO_DIGITAL_OUT_H_ */
